...
(
  ...
  matchTypeDesc VARCHAR2(25)  NOT NULL
);

CREATE TABLE xEVENTS_DESC (
  eventType VARCHAR2(2)  NOT NULL PRIMARY KEY
, eventDesc VARCHAR2(15) NOT NULL
);


CREATE TABLE xMATCH
(
  matchID       NUMBER(4)   GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY, 
  countryID_A   VARCHAR(3)  NOT NULL, 
  countryID_B   VARCHAR(3)  NOT NULL, 
  ...
  CONSTRAINT fk_country_match   FOREIGN KEY (countryID_A) REFERENCES xCOUNTRY(countryID),
  CONSTRAINT fk_country_match   FOREIGN KEY (countryID_B) REFERENCES xCOUNTRY(countryID),
  CONSTRAINT fk_venue_match     FOREIGN KEY (venueID)     REFERENCES xVENUE(venueID),
  CONSTRAINT fk_match_matchType FOREIGN KEY (matchType)   REFERENCES xMATCH_TYPE(matcType)
);
...
CREATE TABLE xEVENTS (
	...
	CONSTRAINT EVENTS_EVENTDESC_FK  FOREIGN KEY (eventType) REFERENCES xEVENT_DESC(eventType),
...
(
    ...
    notify BOOLEAN DEFAULT 0 NOT NULL, 
